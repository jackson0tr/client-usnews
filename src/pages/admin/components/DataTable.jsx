          ...
          <div className="flex flex-row justify-between w-full mb-1 sm:mb-0">
            ...
            <div className="text-end">
              ...
              >
                ...
                <button
                  className="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-primary rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-blue-200"
                  type="submit"
                >
                  Filter
                </button>
