...
const Categories = () => {
    ...
    const {
        ...
        deleteDataMessage: "Category is successfully deleted",
        ...
        <div className='grid grid-cols-12 gap-x-4'>
            <div className="col-span-4 py-8">
                ...
                <div className="d-form-control w-full mt-6">
                    <input value={categoryTitle} className="d-input-bordered border-slate-300 !outline-slate-300 text-xl font-medium font-roboto text-dark-hard"
                    ...
                    className='w-fit mt-3 bg-green-500 text-white font-semibold rounded-lg px-4 py-2 disabled:cursor-not-allowed disabled:opacity-70'>Add Category</button>
                </div>
            </div>
